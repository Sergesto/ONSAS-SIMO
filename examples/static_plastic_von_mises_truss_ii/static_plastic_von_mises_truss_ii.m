...
elements(3).elemCrossSecParams = { 'circle' , 0.010} ;
...
boundaryConds(2).loadsTimeFact = @(t) (t<1)*Fu*t+(t>=1 & t<=2)*(28000-56300*(t-1))+ (t>2 & t<=3)*(-28300 + 57300*(t-2)) + (t>3 & t<=4)*(29000 - 58000*(t-3));
